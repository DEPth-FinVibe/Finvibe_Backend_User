...
public enum WalletErrorCode implements DomainErrorCode {
  INVALID_PHONE_NUMBER_PARAMS("INVALID_PHONE_NUMBER_PARAMS", "error.wallet.invalid_phone_number_params"),
  INVALID_EMAIL_FORMAT("INVALID_EMAIL_FORMAT", "error.wallet.invalid_email_format"),
  INVALID_LOGIN_ID_FORMAT("INVALID_LOGIN_ID_FORMAT", "error.wallet.invalid_login_id_format")
  ;
